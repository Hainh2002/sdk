...
#define DEFAULT__1030__SYNC_BIT_POS_OVER_FLOW_VALUE		(0U)				/* Set according to synchronous scheduled. Setting range: 0-31 */

/*  */
#define DEFAULT__1008__DEVICE_NAME						{'S','E','L','E','X','_','B','S','S'}	/*(12 byte)*/
